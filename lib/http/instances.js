...
// FIXME: parameterize or allow customization?
const {
  postConfigBody, getConfigsQuery
} = require('../../schemas/bedrock-service-object');
const {validate} = require('../validator.js');

bedrock.events.on('bedrock-express.configure.routes', app => {
  // FIXME: parameterize ... convert to class that can be instantiated during
  // this event by users of this module
