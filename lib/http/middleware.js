...
export function authorizeOAuth2AccessToken({
  ...
  */
  // FIXME: combine `action` and `target` to create expected scope
  ...
  // FIXME: parse JWT
  // FIXME: use `oauth2IssuerBaseUrl` to get cached oauth2 issuer information
  // via RFC 8414, including JWK info
  // FIXME: ensure JWT issuer key ID matches an applicable key in the oauth2
  // issuer information
  // FIXME: verify JWT against JWK

  // FIXME: ensure `aud` claim and `scope` match expected values
}
