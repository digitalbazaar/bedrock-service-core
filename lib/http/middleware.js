...
export function authorizeOAuth2AccessToken({
  ...
  // FIXME: first parse JWT

  // FIXME: then use `getRootController` to get controller DID
  // FIXME: ensure JWT issuer matches one of DID's capability invocation
  // verification methods
  // FIXME: verify JWT against verification method
  ...
  */
  ...
  // FIXME: ensure `aud` claim and `scope` are a match
}
