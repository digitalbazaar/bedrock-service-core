 ...
 * @param {object} [options.validation.createConfigBody] - Custom JSON schema
 *   for creating a service object configuration.
 * @param {object} [options.validation.updateConfigBody] - Custom JSON schema
 *   for updating a service object configuration.
